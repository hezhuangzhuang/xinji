...
public class LoginCenter {
    ...
    public ConfConfigInfo getConfAccountInfoFromAuthResult(LoginSmcAuthorizeResult loginSmcAuthorizeResult) {
        ...
        /**
         * Attempt to invoke virtual method 'java.util.List com.huawei.tup.login.LoginSmcAuthorizeResult.getSmcServers()' on a null object reference
         *         at com.huawei.opensdk.sdkwrapper.login.LoginCenter.getConfAccountInfoFromAuthResult(LoginCenter.java:394)
         *         at com.huawei.opensdk.sdkwrapper.manager.AuthEventAdapt.onAuthorizeResult(AuthEventAdapt.java:301)
         */
        //设置会议服务器地址和端口号
        //TODO:if (null != loginSmcAuthorizeResult.getSmcServers()) {可以正常登录
