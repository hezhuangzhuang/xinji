    ...
    public void initVideoWindow(final int callId) {
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                boolean localSetVideo = setVideoWindow(callId, VideoWndType.local, localVideoIndex, displayType);
...
//                displayType = 0;
                ...
                boolean remoteSetVideo = setVideoWindow(callId, VideoWndType.remote, remoteVideoIndex, displayType);
                LogUtil.i(UIConstants.DEMO_TAG, "localSetVideo-->" + localSetVideo + "   , remoteSetVideo-->" + remoteSetVideo);
            }
        });
    }
