...
public class CustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(@NonNull View bottomSheet, @CustomBottomSheetBehavior.State int newState);
    ...
    private CustomBottomSheetBehavior.BottomSheetCallback mCallback;
    ...
    /**
     * Default constructor for instantiating CustomBottomSheetBehaviors.
     */
    public CustomBottomSheetBehavior() {
    }

    /**
     * Default constructor for inflating CustomBottomSheetBehaviors from layout.
     *
     ...
     * @attr ref android.support.design.R.styleable#CustomBottomSheetBehavior_Layout_behavior_peekHeight
     */
     ...
     * @attr ref android.support.design.R.styleable#CustomBottomSheetBehavior_Layout_behavior_hideable
     */
     ...
     * @attr ref android.support.design.R.styleable#CustomBottomSheetBehavior_Layout_behavior_skipCollapsed
     */
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (mViewDragHelper.settleCapturedViewAt(releasedChild.getLeft(), top)) {
                ...
                ViewCompat.postOnAnimation(releasedChild,
                        new CustomBottomSheetBehavior.SettleRunnable(releasedChild, targetState));
            } else {
                setStateInternal(targetState);
            }
        }
