...
public class GlideImageView extends ImageView {
    ...
    public void load(String url, SimpleTarget<Bitmap> target) {
        load(url, 0, null, target);
    }

    public void load(Object obj, @DrawableRes int placeholder, Transformation<Bitmap> transformation,SimpleTarget target) {
        getImageLoader().loadImage(obj, placeholder, transformation,target);
    }
