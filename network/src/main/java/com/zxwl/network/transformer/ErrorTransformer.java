package com.zxwl.network.transformer;


import com.zxwl.network.exception.ExceptionHandle;
import com.zxwl.network.exception.ServerException;
import com.zxwl.network.response.HttpResponse;
        ...
        return httpResponseObservable.map(new Func1<HttpResponse<T>, T>() {
            ...
            public T call(HttpResponse<T> tHttpResponse) {
                if (tHttpResponse.getError() != 0) {
                    // Logger.e("cc", tHttpResponse.toString());
