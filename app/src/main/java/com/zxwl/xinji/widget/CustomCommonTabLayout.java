...
public class CustomCommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public CustomCommonTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mValueAnimator = ValueAnimator.ofObject(new CustomCommonTabLayout.PointEvaluator(), mLastP, mCurrentP);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            if (mIconGravity == Gravity.LEFT) {
                ...
                if (TextUtils.isEmpty(mTabEntitys.get(i).getTabTitle())) {
                    tabView = View.inflate(mContext, R.layout.item_tab_center, null);
                } else {
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        View currentTabView = mTabsContainer.getChildAt(this.mCurrentTab);
        CustomCommonTabLayout.IndicatorPoint p = (CustomCommonTabLayout.IndicatorPoint) animation.getAnimatedValue();
    ...
    private CustomCommonTabLayout.IndicatorPoint mCurrentP = new CustomCommonTabLayout.IndicatorPoint();
    private CustomCommonTabLayout.IndicatorPoint mLastP = new CustomCommonTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<IndicatorPoint> {
        @Override
        public CustomCommonTabLayout.IndicatorPoint evaluate(float fraction, CustomCommonTabLayout.IndicatorPoint startValue, CustomCommonTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            CustomCommonTabLayout.IndicatorPoint point = new CustomCommonTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
