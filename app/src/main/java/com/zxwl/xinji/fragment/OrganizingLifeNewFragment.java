...
public class OrganizingLifeNewFragment extends BaseLazyFragment implements View.OnClickListener {
    ...
    public OrganizingLifeNewFragment() {
    }
...
//    private Toolbar t_test_title;

    public static OrganizingLifeNewFragment newInstance() {
        OrganizingLifeNewFragment fragment = new OrganizingLifeNewFragment();
    ...
    protected View inflateContentView(LayoutInflater inflater, ViewGroup container) {
        return inflater.inflate(R.layout.fragment_organizing_life_new, container, false);
    }
...
//        t_test_title = (Toolbar) view.findViewById(R.id.t_test_title);
