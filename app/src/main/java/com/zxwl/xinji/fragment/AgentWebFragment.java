...
import com.zxwl.xinji.widget.client.CommonWebChromeClient;
...
public class AgentWebFragment extends Fragment implements FragmentKeyDown {
    ...
    public static AgentWebFragment getInstance(Bundle bundle, String url) {
        AgentWebFragment mAgentWebFragment = new AgentWebFragment();
        Bundle newBundle = new Bundle();
        if (bundle != null) {
            newBundle = bundle;
        }
        newBundle.putString(URL_KEY, url);
        mAgentWebFragment.setArguments(newBundle);
