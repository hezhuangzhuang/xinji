...
import com.zxwl.xinji.utils.map.overlay.DrivingRouteOverlay;
import com.zxwl.xinji.utils.map.overlay.WalkRouteOverlay;


/**
 * 驾车出行路线规划 实现
 */
public class DriveRouteActivity extends Activity implements
        OnMapClickListener,
	...
	public static void startActivity(Context context) {
		Intent intent = new Intent(context, DriveRouteActivity.class);
	...
	public void searchRouteResult(int routeType, int mode) {
		if (mStartPoint == null) {
            ToastHelper.showShort("定位中，稍后再试...");
			return;
		}
		if (mEndPoint == null) {
            ToastHelper.showShort("终点未设置");
		}
		showProgressDialog();
...
//							startActivity(intent);
            ...
            ToastHelper.showShort("errorCode:"+errorCode);
		}
	}
