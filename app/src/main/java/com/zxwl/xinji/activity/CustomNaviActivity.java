...
import com.zxwl.xinji.utils.ErrorInfo;
 ...
 * 自定义导航
 */
public class CustomNaviActivity extends RxAppCompatActivity implements AMapNaviListener, AMapNaviViewListener, CancelAdapt {
    ...
    public static void startActivity(Context context) {
        Intent intent = new Intent(context, CustomNaviActivity.class);
