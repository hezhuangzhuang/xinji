...
public class StringUtils {
    ...
    public static Pattern pattern = Pattern.compile("<img.*?src=\\\"(.*?)\\\".*?>");
    /**
    ...
    //开始匹配<img />标签中的src
    public static  Pattern p_src = Pattern.compile("(src|SRC)=(\"|\')(.*?)(\"|\')");

    //开始匹配content中的<img />标签
    public static  Pattern p_img = Pattern.compile("<(img|IMG)(.*?)(/>|></img>|>)");
